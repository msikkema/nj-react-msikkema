...
const ShareButtons = ({
  ...
  const social = [
    {
      ...popupWindowProps(
        `https://facebook.com/sharer.php?u=${encodeURIComponent(
          url
  ...
  return (
    <div className={className}>
      ...
      <button
        className={classNames(classes.socialLink, classes.favouriteButton)}
        type="button"
        onClick={toggleFavourited}
      >
        <span
          className={classNames(
            classes.favouriteIconHolder,
            isFavourited && classes.favouritedIconHolder,
            !isFavourited && classes.unfavouritedIconHolder
          )}
        >
          <Icon
            className={classNames(classes.favouriteIcon, classes.fullHeartIcon)}
            symbol={heartIcon}
          />
          <Icon
            className={classNames(
